...
public class SmsDAO {
	...
	public int sns(SmsVO svo) {
		...
		String api_key = "NCS06XMUZRBXHCYR"; // 발급받은 api_key
		
		String api_secret = "4F0U9FNTXP2KHAQRUKD7Y0C9DL91XS1Z"; // 발급받은 api_secret
		...
		params.put("from","01042370430"); // 발신번호(문자를 보낼 사람)
		
		params.put("type","sms"); // 문자 타입
		params.put("text","[에이센스] 본인인증번호는\n"+randomNum+" 입니다."); // 문자내용
